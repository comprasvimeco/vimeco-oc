...
window.toggleVoiceRecording = async function(btn) {
  ...
  btn.innerHTML = '<span class="import-btn-icon">⏹</span><span class="import-btn-label">Detener</span><span class="import-btn-sub">Grabando…</span>';
  ...
  _recorder.addEventListener('stop', async () => {
    ...
    btn.innerHTML = '<span class="import-btn-icon">🎤</span><span class="import-btn-label">Dictar datos</span><span class="import-btn-sub">Reconocimiento de voz</span>';
